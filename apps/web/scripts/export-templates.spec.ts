...
function buildTemplatesExport() {
  ...
  return {
    ...
    generatedBy: 'pnpm export:templates (apps/web/scripts/export-templates.spec.ts)',
    source: 'code: apps/web/src/domains/program/lib/templates.ts (catalog) + template-definitions.ts (DSL)',
