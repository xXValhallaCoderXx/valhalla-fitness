...
const serverModuleBudgets = new Map([
  ...
  ['src/domains/session/server/session-read-functions.ts', 525],
  ['src/domains/session/server/session-lifecycle-functions.ts', 200],
  ['src/domains/session/server/session-completion-functions.ts', 275],
  ['src/domains/session/server/session-set-functions.ts', 200],
