...
import { Check, Crosshair, Hand, Sparkles, type LucideIcon } from 'lucide-react'
      ...
      <div className="mx-auto grid max-w-[1180px] items-center gap-8 lg:grid-cols-[minmax(0,0.85fr)_minmax(0,1.15fr)] lg:gap-12">
        ...
        <Panel p={0} className="overflow-hidden">
          <div className="space-y-4 p-4 md:p-5">
            ...
            <FocusSetProgressBar movement={movement} selectedSetIndex={selectedIndex} onSelectSet={selectSet} />
