import { programStateKey, type TemplateDefinition, type TemplateSetDefinition } from '@sheetless/domain/program/template-engine'
import { fiveDayDefinitions } from '@sheetless/domain/program/template-definitions-5day'
