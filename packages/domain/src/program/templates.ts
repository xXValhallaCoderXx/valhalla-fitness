import type { ProgramInstance, ProgramTemplateSummary } from '@sheetless/domain/program/types'
...
} from '@sheetless/domain/program/template-definitions'
import { fiveDayCatalog } from '@sheetless/domain/program/template-definitions-5day'
import { applyFamilyMeta } from '@sheetless/domain/program/template-families'
import {
  requiredTrainingMaxState,
  requiredWorkingLoadState,
} from '@sheetless/domain/program/program-state-defaults'
