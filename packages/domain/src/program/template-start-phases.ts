import type { ProgramSetupPreviewMovement, ProgramSetupPreviewWeek } from '@sheetless/domain/program/types'
import { compactWeekPreviewOptions } from '@sheetless/domain/program/template-start-utils'
