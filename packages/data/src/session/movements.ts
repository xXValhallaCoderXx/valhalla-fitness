...
import type { MovementSlot, PlannedSession } from '@sheetless/domain/session/types'
import {
...
async function getSwapContext(supabase: DataClient, userId: string, sessionId: string, exerciseLogId: string): Promise<SwapContext> {
